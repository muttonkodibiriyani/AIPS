...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-ink/82 backdrop-blur-xl">
      <div className="mx-auto flex h-[4.125rem] max-w-6xl items-center justify-between gap-6 px-4">
        ...
        <nav className="flex shrink-0 items-center gap-4 text-[13px] font-medium sm:gap-6">
